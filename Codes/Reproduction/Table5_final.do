...
parmest, format(estimate min95 max95) saving("$project/Results/Reproduction/impulse_ra_alt", replace)
...
#delimit ;
estout e1 e2 e3 e4 e5 e6 e7  using "$project/Results/Reproduction/TableNonPar_RA_alt.tex", style(tex) 
...
parmest, format(estimate min95 max95) saving("$project/Results/Reproduction/impulse_ipw_alt", replace)
...
/* Export table with results to latex */
#delimit ;
estout e1 e2 e3 e4 e5 e6 e7  using "$project/Results/Reproduction/TableNonPar_IPW_alt.tex", style(tex) 
varlabels(effect0 "Average effect of democracy on log GDP") 
cells(b(star fmt(%9.3f)) se(par)) 
keep(effect0) 
order(effect0)
...
parmest, format(estimate min95 max95) saving("$project/Results/Reproduction/impulse_ipwra_alt", replace)
...
/* Export table with results to latex */
#delimit ;
estout e1 e2 e3 e4 e5 e6 e7  using "$project/Results/Reproduction/TableNonPar_IPWRA_alt.tex", style(tex) 
varlabels(effect0 "Average effect of democracy on log GDP") 
cells(b(star fmt(%9.3f)) se(par)) 
keep(effect0) 
order(effect0)
