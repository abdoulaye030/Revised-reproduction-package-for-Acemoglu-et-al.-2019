...
#delimit ;
estout e1A e2A e3A e4A e1B e2B e3B e4B   using "$project/Results/Reproduction/TableInterTop.tex", style(tex) 
varlabels(dem "Democracy" inter "Interaction") 
cells(b(star fmt(%9.3f)) se(par)) 
stats( N N_g, fmt(%7.0f %7.0f) labels("\input{Results/Reproduction/TableInterTop_Add} Observations" "Countries in sample"))  
...
#delimit ;
estout e1A_add e2A_add e3A_add e4A_add e1B_add e2B_add e3B_add e4B_add  using "$project/Results/Reproduction/TableInterTop_Add.tex", style(tex) 
...
#delimit ;
estout e1A e2A e3A e4A e1B e2B e3B e4B using "$project/Results/Reproduction/TableInterMid.tex", style(tex) 
varlabels(dem "Democracy" inter "Interaction") 
cells(b(star fmt(%9.3f)) se(par)) 
stats( widstat jp N N_g , fmt(%7.1f %7.2f %7.0f %7.0f) labels( "\input{Results/Reproduction/TableInterMid_Add} Exc. instruments F-stat." "Hansen p-value" Observations "Countries in sample"  ))  
keep(dem inter) order(dem inter) stardrop(dem inter)  
nolabel replace mlabels(none) collabels(none) ;   
#delimit cr
...
#delimit ;
estout e1A_add e2A_add e3A_add e4A_add e1B_add e2B_add e3B_add e4B_add  using "$project/Results/Reproduction/TableInterMid_Add.tex", style(tex) 
varlabels(longrun "Long-run effect of democracy"  effect$limit "Effect of democracy after $limit years"  persistence "Persistence of GDP process") 
cells(b(star fmt(%9.3f)) se(par)) 
keep(longrun effect$limit persistence) 
order(longrun effect$limit persistence)
...
#delimit ;
estout e1A e2A e3A e4A e1B e2B e3B e4B  using "$project/Results/Reproduction/TableInterBot.tex", style(tex) 
varlabels(dem "Democracy" inter "Interaction") 
cells(b(star fmt(%9.3f)) se(par)) 
stats( N, fmt(%7.0f) labels("\input{Results/Reproduction/TableInterBot_Add} Observations"))  
keep(dem inter) order(dem inter) stardrop(dem inter)
 nolabel replace mlabels(none)  collabels(none)  ;
#delimit cr

#delimit ;
estout e1A_add e2A_add e3A_add e4A_add e1B_add e2B_add e3B_add e4B_add  using "$project/Results/Reproduction/TableInterBot_Add.tex", style(tex) 
varlabels(longrun "Long-run effect of democracy"  effect$limit "Effect of democracy after $limit years"  persistence "Persistence of GDP process") 
cells(b(star fmt(%9.3f)) se(par)) 
keep(longrun effect$limit persistence) 
order(longrun effect$limit persistence)
