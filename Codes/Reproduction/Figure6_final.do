...
use "$project/Data/Analytic/DDCGdata_final.dta", clear
...
graph export "$project/Results/Reproduction/FigureFS.eps", as(eps) preview(off) replace
...
graph export "$project/Results/Reproduction/FigureFSRev.eps", as(eps) preview(off) replace
