...
#delimit ;
estout e1 e2 e3 e4 e5 e6 e7 e8 using "$project/Results/Reproduction/TableControlsTop.tex", style(tex) 
varlabels(dem "Democracy") 
cells(b(star fmt(%9.3f)) se(par)) 
stats( N N_g, fmt(%7.0f %7.0f) labels( "\input{Results/Reproduction/TableControlsTop_Add} Observations" "Countries in sample"))  
keep(dem) 
order(dem)
stardrop(dem)  
...
#delimit ;
estout e1_add e2_add e3_add e4_add e5_add e6_add e7_add e8_add using "$project/Results/Reproduction/TableControlsTop_Add.tex", style(tex) 
...
#delimit ;
estout e1 e2 e3 e4 e5 e6 e7 e8 using "$project/Results/Reproduction/TableControlsMid.tex", style(tex) 
varlabels(dem "Democracy") 
cells(b(star fmt(%9.3f)) se(par)) 
stats( ar2p N N_g , fmt(%7.2f %7.0f %7.0f) labels( "\input{Results/Reproduction/TableControlsMid_Add} AR2 test p-value" Observations "Countries in sample" ))  
keep(dem) 
order(dem) 
stardrop(dem)
nolabel replace mlabels(none) collabels(none) ;  
...
#delimit ;
estout e1_add e2_add e3_add e4_add e5_add e6_add e7_add e8_add using "$project/Results/Reproduction/TableControlsMid_Add.tex", style(tex) 
varlabels(longrun "Long-run effect of democracy"  effect$limit "Effect of democracy after $limit years"  persistence "Persistence of GDP process") 
cells(b(star fmt(%9.3f)) se(par)) 
keep(longrun effect$limit persistence) 
order(longrun effect$limit persistence)
...
#delimit ;
estout e1 e2 e3 e4 e5 e6 e7 e8 using "$project/Results/Reproduction/TableControlsBot.tex", style(tex) 
varlabels(dem "Democracy") 
cells(b(star fmt(%9.3f)) se(par)) stats( N, fmt(%7.0f) labels( "\input{Results/Reproduction/TableControlsBot_Add} Observations"))  
keep(dem) 
order(dem)  
stardrop(dem)   
nolabel replace mlabels(none) collabels(none)  ;
...
#delimit ;
estout e1_add e2_add e3_add e4_add e5_add e6_add e7_add  e8_add using "$project/Results/Reproduction/TableControlsBot_Add.tex", style(tex) 
varlabels(longrun "Long-run effect of democracy"  effect$limit "Effect of democracy after $limit years"  persistence "Persistence of GDP process") 
cells(b(star fmt(%9.3f)) se(par)) 
keep(longrun effect$limit persistence) 
order(longrun effect$limit persistence)
